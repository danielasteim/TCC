...
usando o modelo de SVM de Uma Classe já treinado.
...
class CaptchaSVM:
    # --- Tema azul ---
    COR_FUNDO_JANELA = '#FFEBEE'
    COR_FUNDO_CARTAO = '#FFFFFF'
    COR_PRIMARIA = '#C62828'
    COR_TEXTO_TITULO = '#B71C1C'
    COR_TEXTO_SECUNDARIO = '#9E6B6B'
    COR_APROVADO = '#1B5E20'
    COR_REJEITADO = '#B71C1C'

    NOME_MODELO = "SVM de Uma Classe"
    ARQUIVO_MODELO = "svm_uma_classe.joblib"
    ...
    def montar_interface(self):
        ...
        icone = tk.Label(quadro_checkbox, text="🛡️", font=('Arial', 24), bg=self.COR_FUNDO_CARTAO)
