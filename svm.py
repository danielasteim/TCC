...
class ProductionCaptchaSVM:
    """
    Production CAPTCHA using One-Class SVM
    RED THEME - for easy visual identification
    """
    
    def __init__(self, root, model_dir='models/core_8'):
        self.root = root
        self.root.title("CAPTCHA Verification - SVM")
        self.root.geometry("500x450")
        self.root.configure(bg='#ffe6e6')  # Light red background
    ...
    def load_model(self, model_dir):
        ...
        try:
            ...
            print(f"✅ SVM Model loaded from {model_dir}")
    ...
    def setup_ui(self):
        ...
        main_frame = tk.Frame(self.root, bg='#ffcccc', relief=tk.RAISED, borderwidth=3)
        ...
        self.result_frame = tk.Frame(main_frame, bg='#ffcccc')
    ...
    def verify_human(self):
        """Verify if user is human using SVM"""
        ...
        if self.model is not None:
            ...
            print(f"\n{'='*50}")
            print(f"SVM Verification Result:")
...
if __name__ == "__main__":
    print("="*50)
    print("PRODUCTION CAPTCHA - ONE-CLASS SVM")
    print("="*50)
